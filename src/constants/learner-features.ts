...
export const LEARNER_FEATURES: LearnerFeature[] = [
  ...
  // AI Tools
  { key: 'ai_tutor', label: 'Tuvora A.I', group: 'AI Tools', href: '/portal/more', status: 'soon', icon: Compass, accent: 'from-brand-500 to-violet-700' },
  { key: 'question_solver', label: 'Question solver', group: 'AI Tools', href: '/portal/more', status: 'soon', icon: Sigma, accent: 'from-indigo-500 to-blue-700' },
  { key: 'check_work', label: 'Check my work', group: 'AI Tools', href: '/portal/more', status: 'soon', icon: CircleCheck, accent: 'from-emerald-500 to-teal-700' },
